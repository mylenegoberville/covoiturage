...
class RegistrationController extends AbstractController
{
    ...
    {
        $user = new User();
        $form = $this->createForm(RegistrationFormType::class, $user, array('ajouter'=>true));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('contact@carpooling.com', 'contact carpooling'))
                    ->to($user->getEmail())
    ...
    {
        $user = new User();
        $form = $this->createForm(RegistrationFormType::class, $user, array('ajouterAdmin'=>true));
        $form->handleRequest($request);
